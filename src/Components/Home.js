  ...
  return (
    <>
      ...
      <div className="contact" ref={scollToRef}>
        ...
        <div>
          <a href="https://www.linkedin.com/in/deepikamathivanan/" target="_blank" rel="noopener noreferrer" className="link"><IoLogoLinkedin className="social-icon" /></a>
          <a href="https://github.com/deepika-mathivanan" target="_blank" rel="noopener noreferrer" className="link"><IoLogoGithub className="social-icon" /></a>
        </div>
      </div>
